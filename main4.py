...
/whoami - Текущие настройки
/ask_random <вопрос> - Спросить у случайного персонажа
...
def note_stats(message):
    ...
    # Получаем даты создания заметок
    dates = []
    for note in user_notes:
...
if __name__ == "__main__":
    ...
    # Увеличиваем таймауты и добавляем обработку ошибок
    while True:
        try:
